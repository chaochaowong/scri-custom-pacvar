...
## [1.2.0dev] - extract-clinvar-cosmis [2026-06-28]

### Added
- bin/extract_vep_clinvar_cosmic_csv.py
- modules/local/vep/extract_clinvar_cosmic
- subworkflows/local/vep_post_annotation
